...
// เริ่มแสดงแบนเนอร์แรก
showSlide(currentSlide);

// ตั้งค่าให้เลื่อนแบนเนอร์ทุก 3 วินาที
...
// แสดงข้อมูลในตะกร้า
const addCartToHTML = () => {
    listCartHTML.innerHTML = ''; // ล้างข้อมูลเดิมก่อน
...
const ADDCART = (id) => {
    console.log(id);
    console.log(carts);
    let positionItemInCart = carts.findIndex((value) => value.product_id == id);
